...
export function split_to_chains(pts){
    ...
    // console.log("pts")
    // console.log(pts)
    // console.log("upper_heap")
    // console.log(upper_heap.peek())
    // console.log("lower_heap")
    // console.log(lower_heap.peek())
    //
    // while ((upper_heap.length > 0) && (lower_heap.length > 0)) {
    //     if (upper_heap.peek().x < lower_heap.peek().x) {
    //         console.log(new StackElement(upper_heap.pop(), "upper"));
    //         all_pts.push(new StackElement(upper_heap.pop(), "upper"));
    //     }else{
    //         console.log(new StackElement(lower_heap.pop(), "lower"));
